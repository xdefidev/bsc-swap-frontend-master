...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and MFAX pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and MFAX pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from MFAX pool', data)
  }
